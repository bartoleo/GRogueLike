package com.bartoleo.groguelike.graphic

import com.bartoleo.groguelike.util.Rect
...
class MessageBox {
    ...
    public static def render(SwingPane display, String message, Rect location) {
